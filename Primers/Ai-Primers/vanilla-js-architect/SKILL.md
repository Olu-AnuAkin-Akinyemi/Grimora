...
## Philosophy: Clean Code in Vanilla JS

### Why Vanilla JS Still Matters

Even in a framework-dominated world, vanilla JavaScript skills are essential:

- **Framework-agnostic**: Knowledge transfers to any framework
- **Performance**: No framework overhead (faster load, lower memory)
- **Understanding**: Grasp what frameworks do under the hood
- **Small projects**: Frameworks are overkill for simple sites
- **Web Components**: Modern vanilla JS is powerful

**This primer is for**:
- Developers transitioning from frameworks back to vanilla
- Building lightweight apps where frameworks are excessive
- Learning fundamental patterns before adopting frameworks
- Working on legacy codebases without build tools
